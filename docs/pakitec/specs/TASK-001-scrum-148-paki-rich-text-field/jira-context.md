# Jira Context: SCRUM-148

**Issue**: https://pakitec.atlassian.net/browse/SCRUM-148  
**Summary**: Criar componente Paki para campo de texto rico com flutter_quill  
**Status**: A fazer  
**Assignee**: Unassigned  
...
- O Codex deve implementar no projeto em `/Volumes/External HD/Projetos/pakitec/pakitec-components`.
...
- A branch esperada e `feature/scrum-148-paki-rich-text-field`.
